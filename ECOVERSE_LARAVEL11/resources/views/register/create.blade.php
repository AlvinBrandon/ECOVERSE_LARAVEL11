                    ...
                    <div class="container">
                        <div class="row">
                            ...
                            <div
                                ...
                                <div class="card card-plain p-4" style="box-shadow: 0 4px 24px rgba(16,185,129,0.10);">
                                    ...
                                    <div class="card-body">
                                        <form method="POST" action="{{ route('register') }}">
                                            ...
                                            @error('name')
                                            <p class='text-danger inputerror mb-3'>{{ $message }} </p>
                                            @enderror
                                            <div class="input-group input-group-outline mb-4 mt-3">
                                            ...
                                            <p class='text-danger inputerror mb-3'>{{ $message }} </p>
                                            @enderror
                                            <div class="form-check form-check-info text-start ps-0 mt-3 mb-4">
