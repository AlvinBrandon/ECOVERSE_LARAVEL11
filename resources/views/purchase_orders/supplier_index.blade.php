                ...
                <td>
                  @if($order->invoice_path)
                    <button type="button" class="btn btn-sm btn-outline-primary" onclick="showInvoiceInfo('{{ $order->id }}', '{{ $order->invoice_path }}')">
                      <i class="bi bi-file-earmark-pdf me-1"></i>Invoice Uploaded
                    </button>
                  @else
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <div class="alert alert-info">
          ...
          <strong>Invoice Successfully Uploaded</strong><br>
          <small>Your invoice has been uploaded and is being processed by the admin team.</small>
        </div>
        <div class="row">
        ...
        <div class="row mt-2">
          ...
          <div class="col-sm-8">
            <span class="badge bg-success">Uploaded & Processing</span>
          </div>
        </div>
      </div>
