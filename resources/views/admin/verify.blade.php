              ...
              <td>
                <div class="action-forms">
                  <div class="verification-form">
                    <form action="{{ route('admin.sales.verify', $sale->id) }}" method="POST">
                      @csrf
                      <div class="mb-2">
                      ...
                      <div class="mb-2">
                        ...
                        <input type="text" name="tracking_code" id="tracking_code_{{ $sale->id }}" class="form-control form-control-sm" value="{{ $sale->tracking_code }}" placeholder="Enter tracking code">
                      </div>
                      <div class="mb-3">
                        <label for="dispatch_log_{{ $sale->id }}" class="form-label">Dispatch Log</label>
                        <textarea name="dispatch_log" id="dispatch_log_{{ $sale->id }}" class="form-control form-control-sm" rows="2" placeholder="Enter dispatch notes">{{ $sale->dispatch_log }}</textarea>
                      </div>
                  ...
                  <form action="{{ route('admin.sales.reject', $sale->id) }}" method="POST">
                    @csrf
                    <button type="submit" class="btn btn-danger btn-sm" onclick="return confirm('Are you sure you want to reject this sale?')">
