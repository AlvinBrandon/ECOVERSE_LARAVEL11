  ...
  <div class="row mb-4">
    <div class="col-12 d-flex align-items-center justify-content-between">
      ...
      <div>
        ...
        <a href="{{ route('inventory.raw-materials') }}" class="btn btn-outline-success me-2"><i class="bi bi-droplet-half me-1"></i> Raw Material Inventory</a>
        ...
        <div class="card-body px-0 pt-0 pb-2">
          <div class="table-responsive p-0">
            <table class="table align-items-center mb-0 table-hover">
              ...
              <tbody> --}}
                {{-- Raw material inventory moved to its own widget. --}}
              </tbody>
            </table>
          </div>
        </div>
      </div>
      <!-- Raw Material Inventory section moved to raw-materials.blade.php -->
      {{-- All raw material inventory code has been moved to its own widget/view. --}}
    </div>
  </div>
</div>
