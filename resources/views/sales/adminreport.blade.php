...
<style>
  ...
  .badge.bg-gradient-info, .badge.bg-gradient-success {
...
<div class="container-fluid py-4">
  <div class="row mb-4">
    <div class="col-12 d-flex align-items-center justify-content-between">
      <h4 class="mb-0 fw-bold text-dark"><i class="bi bi-bar-chart me-2"></i>Admin Sales Report</h4>
        ...
        <table class="table align-items-center mb-0 table-hover">
          <thead>
            <tr>
              ...
              <th><i class="bi bi-person me-1"></i>Sold By</th>
