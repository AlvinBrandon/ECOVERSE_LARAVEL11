...
@section('content')
<style>
  /* Modern Professional Order Status Styling */
...
<div class="container-fluid py-4">
  ...
  <div class="page-header">
    <div class="d-flex align-items-center justify-content-between">
      <div>
        <h4><i class="bi bi-clipboard-check me-2"></i>Order Status</h4>
        <p class="mb-0 opacity-75">Track your orders and delivery status</p>
      </div>
